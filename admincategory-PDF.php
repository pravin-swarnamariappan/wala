<?php
        ...
        class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Ln(7);
            $this->Cell(0,10,'Products Categories Report',0,0,'C');
    ...
    $pdf->SetFont('','B');
    // Header
    $header = array('Category ID', 'Title', 'Description');
    //$w = array(40, 35, 40, 45);
    ...
    while($row = mysqli_fetch_array($result)) {
        $pdf->Cell(60,6,$row['id'],'LR',0,'L',$fill);
        $pdf->Cell(40,6,$row['title'],'LR',0,'L',$fill);
        $pdf->Cell(40,6,$row['description'],'LR',0,'L',$fill);
        $pdf->Ln();
        $fill = !$fill;
    }
    // Closing line
